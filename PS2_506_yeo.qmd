...
random_walk2 <- function(n) {
  ...
  # print(random_step)
  #random_step2 <- runif(n)
  #print(random_step2)
#0.8659590 0.7014217 0.3904731 0.3147697 0.8459473 0.1392785 0.5181206 0.5935508 0.9424617 0.6280196
...
#8 + 2 + 8 + 6 = 24 check
total_car_pass <- midnight_to_seven_day + rush_hour_day 
                  + nine_to_four_day + six_to_eleven_day
mean(total_car_pass)
```
